...
(ert-deftest semi-should-return-as-expected-when-setting-is-on-always ()
...
(ert-deftest semi-should-return-the-default-when-setting-is-always-but-disabled ()
...
(ert-deftest semi-should-return-as-expected-when-setting-is-never ()
...
(ert-deftest semi-should-return-as-expected-when-setting-is-never-but-disabled ()
...
(ert-deftest semi-should-return-as-expected-when-the-setting-is-on-but-has-no-value ()
...
(ert-deftest semi-should-return-as-expected-when-the-setting-is-off-and-has-no-value ()
...
(ert-deftest semi-should-return-as-expected-when-the-rule-is-not-defined ()
